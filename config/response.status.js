...
export const status = {
    ...
    PARAMETER_IS_WRONG: {status: StatusCodes.FORBIDDEN, "isSuccess": false, "code": "COMMON005", "message": "변수가 잘 못 됐습니다." },
    ...
    EMAIL_ALREADY_EXIST: {status: StatusCodes.BAD_REQUEST, "isSuccess": false, "code": "MEMBER4003", "message": "존재하는 아이디입니다."},
